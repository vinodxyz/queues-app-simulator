...
import svgPaths from "./svg-dagohs6a5r";
...
function Icon24Px({ children }: React.PropsWithChildren<{}>) {
  return (
...
function Left2({ children }: React.PropsWithChildren<{}>) {
  return (
...
function Wrapper6({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper6Props>) {
  return (
    <div className={clsx("relative shrink-0 w-[393px]", additionalClassNames)}>
      <div className="flex flex-col items-center justify-center size-full">
...
function Wrapper5({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper5Props>) {
  return (
    <div className={clsx("h-0 w-[361px]", additionalClassNames)}>
      <div className="absolute inset-[-0.5px_0_0_0]">
...
type ChatChevronProps = {
  additionalClassNames?: string;
};

function ChatChevron({ additionalClassNames = "" }: ChatChevronProps) {
  return (
...
function ChatHelper({ additionalClassNames = "" }: ChatHelperProps) {
  return (
...
function Actions({ additionalClassNames = "" }: ActionsProps) {
  return (
    <div className={clsx("absolute h-[162px] left-0 w-[393px]", additionalClassNames)}>
      ...
      <div className="absolute bg-white bottom-[34px] content-stretch flex flex-col items-start left-0 pb-[8px] pt-[16px] px-[16px] w-[393px]">
        <div className="bg-[#5b5fc7] cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="Button Full-width (Teams 2 iOS)">
          <div className="flex flex-col items-center size-full">
            <div className="content-stretch flex flex-col items-center px-[20px] py-[14px] relative w-full">
              <div className="content-stretch flex gap-[8px] h-[24px] items-center overflow-clip relative shrink-0">
                <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon">
      ...
      <div className="absolute bg-[#f1f1f1] h-[52px] left-0 top-0 w-[393px]">
...
export default function Chat() {
  return (
    <div className="bg-white overflow-clip relative rounded-[56px] size-full" data-name="Chat">
      <div className="absolute bg-white h-[53px] left-0 top-0 w-[393px]" data-name="StatusBar">
        ...
        <div className="absolute content-stretch flex flex-col h-[53px] items-center justify-center left-0 top-0 w-[134px]" data-name="Left Side">
          <div className="h-[21px] relative rounded-[24px] shrink-0 w-[54px]" data-name="StatusBar-time">
            <p className="-translate-x-1/2 absolute font-['SF_Pro_Text:Medium',sans-serif] h-[20px] leading-[20px] left-[27px] not-italic text-[17px] text-black text-center top-px tracking-[-0.24px] w-[54px] whitespace-pre-wrap">9:41</p>
          </div>
        </div>
        ...
        <div className="bg-white content-stretch flex h-[48px] items-center justify-between relative shrink-0 w-full" data-name="Navigation Header">
                ...
                <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative" data-name="Title+subtext">
                  <div className="relative shrink-0" data-name="Avatar (Teams 2 iOS)">
                    <div className="content-stretch flex gap-[10px] items-start relative">
                      ...
                      <div className="absolute bottom-0 right-0 size-[14px]" data-name="Presence (Teams 2 iOS)">
                        <div className="absolute bottom-[1.4px] right-[1.4px] size-[11.2px]" data-name="Shared / Presence / 16 / ⚪️ Busy - Light">
                  ...
                  <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative" data-name="Container">
                    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Title">
                      <div className="flex flex-col font-['SF_Pro_Text:Medium',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[17px] text-black text-ellipsis tracking-[-0.24px] whitespace-nowrap">
                        <p className="leading-[20px] overflow-hidden">Bruno Zhao</p>
                      </div>
                    </div>
                    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Subtext">
                      <div className="flex flex-col font-['SF_Pro_Text:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#6e6e6e] text-[11px] text-ellipsis tracking-[0.06px] whitespace-nowrap">
                        <p className="leading-[11px] overflow-hidden">Busy</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="content-stretch flex h-full items-center justify-end pr-[18px] relative shrink-0" data-name="Right">
            <div className="content-stretch flex gap-[20px] items-start relative shrink-0" data-name="Nav title icons">
              <Icon2 />
              <Wrapper2>
                <path d={svgPaths.p1b4cd780} fill="var(--fill-0, black)" id="Shape" />
              </Wrapper2>
            </div>
          </div>
        </div>
      </NavigationBarTeams2IOs>
      <Actions additionalClassNames="bottom-[-190px]" />
      <div className="absolute bg-white bottom-[-985px] h-[945px] left-0 overflow-clip rounded-tl-[16px] rounded-tr-[16px] w-[393px]" data-name="Bulk opt in">
        ...
        <div className="absolute content-stretch flex flex-col items-start left-0 top-[69px] w-[393px]" data-name="Content">
          ...
          <div className="content-stretch cursor-pointer flex flex-col items-end overflow-clip relative rounded-[12px] shrink-0 w-[393px]" data-name="Agent list">
            <Wrapper4 additionalClassNames="w-full">
      ...
      <div className="absolute bg-[rgba(0,0,0,0)] h-[850px] left-0 top-0 w-[393px]" data-name="Bottom sheet">
        <div className="absolute bottom-[-300px] content-stretch flex flex-col items-start left-0 overflow-clip rounded-tl-[14px] rounded-tr-[14px]" data-name=".Base_Sheet">
          <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
            <Wrapper6 additionalClassNames="bg-white h-[20px]">
              <div className="bg-[#919191] h-[4px] rounded-[2px] shrink-0 w-[36px]" data-name="Handle" />
            </Wrapper6>
            <div className="bg-white h-[44px] min-h-[44px] relative shrink-0 w-[393px]" data-name="Teams UI/Navigation Header">
              <div className="content-stretch flex items-start min-h-[inherit] relative size-full">
                <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Content">
                  <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col items-center leading-[0] left-[calc(50%+0.5px)] not-italic text-center top-1/2 whitespace-nowrap" data-name="Label">
                    <div className="flex flex-col font-['SF_Pro_Text:Semibold',sans-serif] justify-center relative shrink-0 text-[17px] text-black tracking-[-0.408px]">
                      <p className="leading-[22px]">Cecil Folk</p>
                    </div>
                    <div className="flex flex-col font-['SF_Pro_Text:Regular',sans-serif] justify-center relative shrink-0 text-[#6e6e6e] text-[12px]">
                      <p className="leading-[16px]">In a call</p>
                    </div>
                  </div>
                  <div className="-translate-y-1/2 absolute right-[-32px] top-[calc(50%+14px)]" data-name="Premitive/icon-right">
                    <div className="flex flex-row items-center justify-center size-full">
            ...
            <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="List">
              <Wrapper5 additionalClassNames="relative shrink-0">
                <line id="Line 24" stroke="var(--stroke-0, #E1E1E1)" strokeWidth="0.5" x2="361" y1="0.25" y2="0.25" />
              </Wrapper5>
              <div className="h-0 relative shrink-0 w-full">
                <div className="absolute inset-[-0.5px_0_0_0]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 393 0.5">
                    <line id="Line 23" stroke="var(--stroke-0, #E1E1E1)" strokeWidth="0.5" x2="393" y1="0.25" y2="0.25" />
                  </svg>
                </div>
              </div>
              <Wrapper6 additionalClassNames="cursor-pointer h-[46px]">
                <div className="absolute bg-white inset-0" data-name="BG" />
                <Content1>
                  <Left1>
                    <Icon24Px>
                      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[18.005px] top-1/2" data-name="Shape">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.0046 18.0049">
                          <path d={svgPaths.p33914d00} fill="var(--fill-0, black)" id="Shape" />
                        </svg>
                      </div>
                    </Icon24Px>
                    <TextText text="Opt into queue" />
                  </Left1>
                </Content1>
              </Wrapper6>
              <Wrapper6 additionalClassNames="cursor-pointer h-[46px]">
          ...
          <Wrapper4 additionalClassNames="bg-white w-[393px]">
            <div className="h-[34px] relative shrink-0 w-[134px]">
              <div className={`absolute rounded-[100px] ${"iPhone" === "iPad" && "Portrait" === "Landscape" && "Light" === "Dark" ? "-translate-x-1/2 bg-white bottom-[7.5px] h-[5.5px] left-1/2 w-[315px]" : "iPhone" === "iPad" && "Portrait" === "Portrait" && "Light" === "Dark" ? "-translate-x-1/2 bg-white h-[5.5px] left-1/2 top-[8px] w-[273px]" : "iPhone" === "iPhone" && "Portrait" === "Landscape" && "Light" === "Dark" ? "bg-white bottom-[9px] h-[5px] left-0 right-0" : "iPhone" === "iPhone" && "Portrait" === "Compact" && "Light" === "Dark" ? "-translate-x-1/2 bg-white bottom-[7px] h-[4px] left-1/2 w-[113px]" : "iPhone" === "iPhone" && "Portrait" === "Portrait" && "Light" === "Dark" ? "-translate-x-1/2 bg-white bottom-[8px] h-[5px] left-1/2 w-[134px]" : "iPhone" === "iPad" && "Portrait" === "Landscape" && "Light" === "Light" ? "-translate-x-1/2 bg-black bottom-[7.5px] h-[5.5px] left-1/2 w-[315px]" : "iPhone" === "iPad" && "Portrait" === "Portrait" && "Light" === "Light" ? "-translate-x-1/2 bg-black h-[5.5px] left-1/2 top-[8px] w-[273px]" : "iPhone" === "iPhone" && "Portrait" === "Landscape" && "Light" === "Light" ? "bg-black bottom-[8px] h-[5px] left-0 right-0" : "iPhone" === "iPhone" && "Portrait" === "Compact" && "Light" === "Light" ? "-translate-x-1/2 bg-black bottom-[7px] h-[4px] left-1/2 w-[113px]" : "-translate-x-1/2 bg-black bottom-[8px] h-[5px] left-1/2 w-[134px]"}`} data-name="Home indicator" />
            </div>
          </Wrapper4>
        </div>
      </div>
      <Actions additionalClassNames="bottom-[-180px]" />
      ...
      <ChatHelper additionalClassNames="top-[216px]" />
      <ChatHelper additionalClassNames="top-[768px]" />
      <ChatHelper additionalClassNames="top-[292px]" />
      <ChatHelper additionalClassNames="top-[368px]" />
      <ChatHelper additionalClassNames="top-[464px]" />
      <ChatHelper additionalClassNames="top-[844px]" />
      <ChatHelper additionalClassNames="top-[920px]" />
      <ChatHelper additionalClassNames="top-[996px]" />
      <ChatHelper additionalClassNames="top-[540px]" />
      <ChatHelper additionalClassNames="top-[616px]" />
      <ChatHelper additionalClassNames="top-[692px]" />
      <ChatChevron additionalClassNames="top-[786px]" />
      <ChatChevron additionalClassNames="top-[158px]" />
      <ChatChevron additionalClassNames="top-[234px]" />
      <ChatChevron additionalClassNames="top-[310px]" />
      <ChatChevron additionalClassNames="top-[710px]" />
      <ChatChevron additionalClassNames="top-[862px]" />
      <ChatChevron additionalClassNames="top-[938px]" />
      <ChatChevron additionalClassNames="top-[1014px]" />
      <ChatChevron additionalClassNames="top-[386px]" />
      <ChatChevron additionalClassNames="top-[482px]" />
      <ChatChevron additionalClassNames="top-[558px]" />
      <ChatChevron additionalClassNames="top-[634px]" />
      ...
      <div className="absolute bg-[rgba(255,255,255,0)] h-[1580px] left-0 top-[53px] w-[393px]" data-name="Bottom sheet">
        <div className="absolute bg-white bottom-0 h-[1580px] left-0 rounded-tl-[16px] rounded-tr-[16px] w-[393px]" data-name="Contents">
          ...
          <div className="absolute contents left-0 top-[122px]">
            ...
            <Wrapper5 additionalClassNames="absolute left-[16px] top-[122px]">
      ...
      <div className="absolute bg-white h-[751px] left-0 top-[99px] w-[393px]" data-name="[TFW] Chat L2 1:1 (iOS)">
              ...
              <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Self">
                <ChatBubbleTeams2IOs>
                  <div className="content-stretch flex gap-[4px] items-start justify-end relative shrink-0" data-name="Container">
                    <div className="content-stretch flex flex-col items-end justify-center max-w-[275px] relative shrink-0" data-name="Bubble">
                      <div className="bg-[#5b5fc7] content-stretch flex items-center p-[8px] relative rounded-[12px] shrink-0" data-name="Content">
                        <Wrapper7>{`Morning. Can you check if the call queue for Nurse line is active? `}</Wrapper7>
                      </div>
                    </div>
                    <div className="content-stretch flex flex-col items-center justify-end pl-[2px] pr-[6px] self-stretch shrink-0" data-name="Seen icon" />
                  </div>
                        ...
                        <div className="content-stretch flex gap-[13px] items-end relative shrink-0 w-full" data-name="Content">
                          ...
                          <div className="content-stretch flex flex-col items-start py-[8px] relative shrink-0" data-name="Mic">
                            <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Mic">
                              <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[20px] left-1/2 top-1/2 w-[14px]" data-name="Shape">
