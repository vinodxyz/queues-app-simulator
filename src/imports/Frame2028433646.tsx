...
import svgPaths from "./svg-7qav5i78ss";
...
function Wrapper11({ children, additionalClassNames = "" }: React.PropsWithChildren<Wrapper11Props>) {
  return (
    <div className={clsx("absolute bg-white left-[575px] w-[393px]", additionalClassNames)}>
      <div className="content-stretch flex flex-col items-start pb-[20px] pt-[8px] relative w-full">{children}</div>
    </div>
  );
}
...
function ListItemOneLineTeams2IOs3() {
  return (
    <Wrapper>
...
function ListItemOneLineTeams2IOs2() {
  return (
    <Wrapper>
      <div className="absolute bg-white inset-0" data-name="BG" />
      <Wrapper2>
...
function ListItemOneLineTeams2IOs1() {
  return (
    <Wrapper>
      <div className="absolute bg-white inset-0" data-name="BG" />
      <Wrapper2>
...
function PeopleActionsIOs({ className, role = "Supervisor", viewing = "Agent" }: PeopleActionsIOsProps) {
  ...
  const isAgentAndIsAgentOrSupervisor = role === "Agent" && ["Agent", "Supervisor"].includes(viewing);
  const isAgentAndIsAgentOrSupervisorOrSelf = role === "Agent" && ["Agent", "Supervisor", "Self"].includes(viewing);
      ...
      <div className="content-stretch flex flex-col items-start pb-[20px] pt-[8px] relative w-full">
        <NavigationBarTeams2IOs>
          <div className="content-stretch flex h-[48px] items-center relative shrink-0 w-full" data-name="Navigation header">
            <div className="content-stretch flex flex-[1_0_0] flex-col h-[48px] items-center justify-center min-h-px min-w-px relative" data-name="Center">
              <Wrapper5>{isSupervisorAndSelf ? "Lydia Bauer (You)" : isSupervisorAndSupervisor ? "Hillary Reyes" : isAgentAndIsAgentOrSupervisorOrSelf ? "Title" : "Keiko Tanaka"}</Wrapper5>
              <Wrapper4>{isSupervisorAndSelf ? "Opted in" : isSupervisorAndSupervisor ? "Opted out" : isAgentAndIsAgentOrSupervisorOrSelf ? "Subtitle" : "In a call"}</Wrapper4>
            </div>
        ...
        <PeopleActionsIOsListItemOneLineTeams2IOs>
          <div className="content-stretch flex items-center pr-[12px] py-[12px] relative w-full">
            <div className="content-stretch flex items-center pr-[20px] relative shrink-0" data-name="Icon 24px">
              <div className={`relative shrink-0 size-[24px] ${isAgentAndAgent || isAgentAndSupervisor || isAgentAndSelf || isSupervisorAndSelf ? "" : "overflow-clip"}`} data-name="Icon">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute top-1/2 ${isSupervisorAndSelf ? "h-[18px] left-[calc(50%+0.5px)] w-[19px]" : isSupervisorAndSupervisor ? "h-[20.096px] left-[calc(50%-0.1px)] w-[15.302px]" : isAgentAndIsAgentOrSupervisorOrSelf ? "left-1/2 size-[20px]" : "left-1/2 size-[18.005px]"}`} data-name="Shape">
                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={isSupervisorAndSelf ? "0 0 19 18" : isSupervisorAndSupervisor ? "0 0 15.3017 20.0959" : isAgentAndIsAgentOrSupervisorOrSelf ? "0 0 20 20" : "0 0 18.0046 18.0049"}>
                    <path clipRule={isAgentAndIsAgentOrSupervisorOrSelf ? "evenodd" : undefined} d={isSupervisorAndSelf ? svgPaths.p3b564c00 : isSupervisorAndSupervisor ? svgPaths.p39b37080 : isAgentAndIsAgentOrSupervisorOrSelf ? svgPaths.p399cfc00 : svgPaths.p33914d00} fill={isAgentAndIsAgentOrSupervisorOrSelf ? "var(--fill-0, #242424)" : "var(--fill-0, black)"} fillRule={isAgentAndIsAgentOrSupervisorOrSelf ? "evenodd" : undefined} id="Shape" />
                  </svg>
                </div>
              </div>
            </div>
            <Wrapper6>{isSupervisorAndSelf ? "Opt out" : isAgentAndAgent || isAgentAndSupervisor || isSupervisorAndSupervisor ? "Call" : isAgentAndSelf ? "Opt in" : "Opt in"}</Wrapper6>
          </div>
        </PeopleActionsIOsListItemOneLineTeams2IOs>
        <PeopleActionsIOsListItemOneLineTeams2IOs>
          <div className="content-stretch flex items-center pr-[12px] py-[12px] relative w-full">
            <div className="content-stretch flex items-center pr-[20px] relative shrink-0" data-name="Icon 24px">
              <div className={`relative shrink-0 size-[24px] ${isAgentAndIsAgentOrSupervisorOrSelf ? "" : "overflow-clip"}`} data-name="Icon">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute top-1/2 ${isSupervisorAndSelf ? "h-[16.005px] left-1/2 w-[20px]" : isSupervisorAndSupervisor ? "h-[20.002px] left-1/2 w-[20px]" : isAgentAndIsAgentOrSupervisorOrSelf ? "left-1/2 size-[20px]" : "h-[20.096px] left-[calc(50%-0.1px)] w-[15.302px]"}`} data-name="Shape">
                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={isSupervisorAndSelf ? "0 0 20 16.0046" : isSupervisorAndSupervisor ? "0 0 20 20.0017" : isAgentAndIsAgentOrSupervisorOrSelf ? "0 0 20 20" : "0 0 15.3017 20.0959"}>
                    <path clipRule={isAgentAndIsAgentOrSupervisorOrSelf ? "evenodd" : undefined} d={isSupervisorAndSelf ? svgPaths.p27af3f00 : isSupervisorAndSupervisor ? svgPaths.p3c8e8a00 : isAgentAndIsAgentOrSupervisorOrSelf ? svgPaths.p399cfc00 : svgPaths.p39b37080} fill={isAgentAndIsAgentOrSupervisorOrSelf ? "var(--fill-0, #242424)" : "var(--fill-0, black)"} fillRule={isAgentAndIsAgentOrSupervisorOrSelf ? "evenodd" : undefined} id="Shape" />
                  </svg>
                </div>
              </div>
            </div>
            <Wrapper6>{viewing === "Self" && ["Agent", "Supervisor"].includes(role) ? "View profile" : isAgentAndAgent || isAgentAndSupervisor || isSupervisorAndSupervisor ? "Send message" : "Call"}</Wrapper6>
          </div>
        </PeopleActionsIOsListItemOneLineTeams2IOs>
        {(isSupervisorAndAgent || isAgentAndAgent || isAgentAndSupervisor || isSupervisorAndSupervisor) && (
          <PeopleActionsIOsListItemOneLineTeams2IOs>
            <div className="content-stretch flex items-center pr-[12px] py-[12px] relative w-full">
              <div className="content-stretch flex items-center pr-[20px] relative shrink-0" data-name="Icon 24px">
                <div className={`relative shrink-0 size-[24px] ${isAgentAndIsAgentOrSupervisor ? "" : "overflow-clip"}`} data-name="Icon">
                  <div className={`-translate-x-1/2 -translate-y-1/2 absolute left-1/2 top-1/2 ${isSupervisorAndSupervisor ? "h-[16.005px] w-[20px]" : isAgentAndIsAgentOrSupervisor ? "size-[20px]" : "h-[20.002px] w-[20px]"}`} data-name="Shape">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={isSupervisorAndSupervisor ? "0 0 20 16.0046" : isAgentAndIsAgentOrSupervisor ? "0 0 20 20" : "0 0 20 20.0017"}>
                      <path clipRule={isAgentAndIsAgentOrSupervisor ? "evenodd" : undefined} d={isSupervisorAndSupervisor ? svgPaths.p27af3f00 : isAgentAndIsAgentOrSupervisor ? svgPaths.p399cfc00 : svgPaths.p3c8e8a00} fill={isAgentAndIsAgentOrSupervisor ? "var(--fill-0, #242424)" : "var(--fill-0, black)"} fillRule={isAgentAndIsAgentOrSupervisor ? "evenodd" : undefined} id="Shape" />
                    </svg>
                  </div>
                </div>
              </div>
              <Wrapper6>{isAgentAndAgent || isAgentAndSupervisor || isSupervisorAndSupervisor ? "View profile" : "Send message"}</Wrapper6>
            </div>
          </PeopleActionsIOsListItemOneLineTeams2IOs>
        )}
...
export default function Frame() {
  return (
    <div className="bg-black relative size-full">
      <Wrapper11 additionalClassNames="top-[182px]">
        <NavigationBarTeams2IOs>
          <div className="content-stretch flex h-[48px] items-center relative shrink-0 w-full" data-name="Navigation header">
            <div className="content-stretch flex flex-[1_0_0] flex-col h-[48px] items-center justify-center min-h-px min-w-px relative" data-name="Center">
              <TitleText text="Keiko Tanaka" />
              <SubtextText text="In a call" />
            </div>
            <div className="absolute content-stretch flex h-[48px] items-center left-0 pl-[16px] top-0" data-name="Left" />
          </div>
        </NavigationBarTeams2IOs>
        <Wrapper>
          ...
          <Wrapper2>
            <Wrapper3>
              ...
              <TextText text="Opt in" />
            </Wrapper3>
          </Wrapper2>
        </Wrapper>
        <ListItemOneLineTeams2IOs1 />
        <ListItemOneLineTeams2IOs2 />
        <ListItemOneLineTeams2IOs3 />
      </Wrapper11>
      <PeopleActionsIOs className="absolute bg-white left-[575px] top-[530px] w-[393px]" viewing="Supervisor" />
      <Wrapper11 additionalClassNames="top-[826px]">
        <NavigationBarTeams2IOs>
          <div className="content-stretch flex h-[48px] items-center relative shrink-0 w-full" data-name="Navigation header">
            <div className="content-stretch flex flex-[1_0_0] flex-col h-[48px] items-center justify-center min-h-px min-w-px relative" data-name="Center">
              <TitleText text="Lydia Bauer (You)" />
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] leading-[32px] left-[575px] not-italic text-[20px] text-white top-[140px]">Agent</p>
      <p className="absolute font-['Inter:Regular',sans-serif] leading-[32px] left-[575px] not-italic text-[20px] text-white top-[480px]">Another lead</p>
      <p className="absolute font-['Inter:Regular',sans-serif] leading-[32px] left-[575px] not-italic text-[20px] text-white top-[781px]">Self</p>
      <div className="absolute h-[850px] left-[92px] overflow-clip rounded-[56px] top-[174px] w-[393px]" data-name="Supervisor/Queue details">
        <div className="absolute bg-white bottom-0 content-stretch flex flex-col items-start left-0 overflow-x-clip overflow-y-auto top-0 w-[393px]" data-name="Queue details">
          ...
          <Wrapper7 additionalClassNames="cursor-pointer">
            <div className="absolute bg-white inset-0" data-name="BG" />
            <Wrapper2>
              <Wrapper3>
                ...
                <div className="bg-white relative shrink-0 w-full" data-name="Content">
                  <div className="overflow-clip rounded-[inherit] size-full">
                    <div className="content-stretch flex items-start px-[8px] relative w-full">
                      <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative" data-name="Role=Supervisor, Viewing=Agent">
                        <div className="content-stretch flex flex-col items-start pb-[20px] pt-[8px] relative w-full">
                          <NavigationBarTeams2IOs>
                            <div className="content-stretch flex h-[48px] items-center relative shrink-0 w-full" data-name="Navigation header">
                              <div className="content-stretch flex flex-[1_0_0] flex-col h-[48px] items-center justify-center min-h-px min-w-px relative" data-name="Center">
