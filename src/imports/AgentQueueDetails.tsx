...
import svgPaths from "./svg-mqp5mmig8v";
type Wrapper2Props = {
...
function Content2DatapointIOs({ children }: React.PropsWithChildren<{}>) {
  return (
...
function CallStatusIOs() {
  return (
    <div className="bg-[#fdf3f4] relative rounded-[9999px] shrink-0">
      <div className="flex flex-row items-center size-full">
...
export default function AgentQueueDetails() {
  return (
    <div className="overflow-clip relative rounded-[56px] size-full" data-name="Agent/Queue details">
      <div className="absolute bg-white bottom-0 content-stretch flex flex-col items-start left-0 overflow-x-clip overflow-y-auto top-0 w-[393px]" data-name="Queue details">
        ...
        <Wrapper2 additionalClassNames="cursor-pointer w-full">
        ...
        <div className="content-stretch flex flex-col items-start pt-[8px] relative shrink-0 w-[393px]" data-name="Call list">
          <Wrapper2 additionalClassNames="bg-white w-[393px]">
          ...
          <Wrapper2 additionalClassNames="bg-white w-[393px]">
            <div className="content-stretch flex items-center py-[12px] relative shrink-0 w-full" data-name="Container">
              ...
              <div className="flex flex-row items-center self-stretch">
                <RightAccessoriesText text="8:32 AM" />
              </div>
            </div>
            <CallListBottomDivider />
          </Wrapper2>
          ...
          <Wrapper2 additionalClassNames="bg-white w-[393px]">
            <div className="content-stretch flex items-center py-[12px] relative shrink-0 w-full" data-name="Container">
              ...
              <div className="flex flex-row items-center self-stretch">
                <RightAccessoriesText text="7:24 AM" />
              </div>
            </div>
            <CallListBottomDivider />
          </Wrapper2>
