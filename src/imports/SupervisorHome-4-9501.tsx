import svgPaths from "./svg-6kxb2h44dk";
...
function Text({ text, text1 }: TextProps) {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['SF_Pro_Text:Regular',sans-serif] items-start justify-center leading-[0] min-h-px min-w-px not-italic relative">
      ...
      <div className="flex flex-col justify-center opacity-0 overflow-hidden relative shrink-0 text-[#6e6e6e] text-[15px] text-ellipsis tracking-[-0.08px] w-full whitespace-nowrap">
        <p className="leading-[20px] overflow-hidden">{text1}</p>
      </div>
    </div>
  );
...
export default function SupervisorHome() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative rounded-[56px] size-full" data-name="Supervisor/Home">
            ...
            <div className="content-stretch flex flex-col items-center justify-center relative">
              ...
              <div className="content-stretch flex items-center justify-center relative shrink-0 w-[393px]" data-name="Content">
                ...
                <div className="flex flex-row items-center self-stretch">
                  <div className="content-stretch flex gap-[8px] h-full items-center pb-[8px] pt-[16px] px-[12px] shrink-0" data-name="Right" />
                </div>
              </div>
            </div>
          </div>
        ...
        <ListItemMultipleLines>
          ...
          <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative" data-name="Content">
            <Left>
              ...
              <Text text="Primary care - nurse line" text1="2 opted in" />
            </Left>
            <div className="flex flex-row items-center self-stretch">
              <Right />
            </div>
          ...
          <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative" data-name="Content">
            ...
            <div className="flex flex-row items-center self-stretch">
              <div className="content-stretch flex gap-[8px] h-full items-center px-[12px] relative shrink-0" data-name="Right">
                <div className="opacity-0 overflow-clip relative shrink-0 size-[24px]" data-name="R.Icon 1">
      ...
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[186px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[260px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[334px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[430px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[504px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[578px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[652px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
      <div className="absolute bg-gradient-to-r from-[rgba(0,0,0,0.1)] h-[16px] left-[72px] rounded-[2px] to-[86%] to-[rgba(0,0,0,0.03)] top-[726px] via-1/2 via-[rgba(0,0,0,0.1)] w-[84px]" data-name="236px" />
    </div>
  );
}